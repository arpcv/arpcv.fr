<?
	...
	$sql = "select * from entete where chapitre_entete = 'village'";
	$qry = mysql_query($sql);
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="1" class="text">
              <tr>
                ...
                <td height="20" background="decoup/header_vert.jpg"><strong>Chapitre</strong></td>
                </tr>
              <?
...
?>
              <tr <? if ($i%2 == 1) echo "bgcolor=#ebfae1"?>>
                <td align="left" valign="top"><strong><? echo $rec['nom_village']; ?></strong></td>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				<?
				//listage des chapitre
				$sql_chap = "SELECT * FROM chapitre WHERE idvillage_chapitre = ".$rec['id_village'];
				$qry_chap = mysql_query($sql_chap);
				while ($rec_chap = mysql_fetch_array($qry_chap)) {
				?>
                  <tr>
                    <td class="text"><a href="chapitre_detail.php?id=<? echo $rec_chap['id_chapitre']; ?>&village=<? echo $rec['nom_village']; ?>" class="text"><? echo $rec_chap['nom_chapitre']; ?></a></td>
                  </tr>
				 <? 
				 }
				 ?>
      ...
      <tr>
        <td><img src="decoup/model_pied.jpg" width="780" height="53" border="0" usemap="#Map2" /></td>
      </tr>
    </table></td>
    <td valign="top"><img src="decoup/model_bande.jpg" width="100%" height="600" /></td>
...
<map name="Map" id="Map"><area shape="rect" coords="77,32,127,97" href="http://arpcv.free.fr" target="_blank" />
</map>
<map name="Map2" id="Map2"><area shape="rect" coords="217,9,563,43" href="mailto:sitesaintevictoire@free.fr" target="_blank" />
</map></body>
</html>
<?
	mysql_close();
