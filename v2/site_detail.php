      ...
      <tr>
        <td background="decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<? } else { ?>
			<a href="site.php" class="text">Retour</a>
			<? } ?>
			</p>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                  <tr>
					...
					?>
					<img src="images/site/<? echo $rec['photo1_monument']?>" width="200" onclick="MM_openBrWindow('admin/photozoom.php?fn=<? echo "images/site/".$rec['photo1_monument']?>','','width=<? echo $t1[0]; ?>,height=<? echo $t1[1]; ?>')">
					<? }?>
					 <br /><br /> 
					<?
					...
					?>
					<img src="images/site/<? echo $rec['photo2_monument']?>" width="200" onclick="MM_openBrWindow('admin/photozoom.php?fn=<? echo "images/site/".$rec['photo2_monument']?>','','width=<? echo $t2[0]; ?>,height=<? echo $t2[1]; ?>')">
					<? }?>
					<br /><br />
					<?
					...
					?>
					<img src="images/site/<? echo $rec['photo3_monument']?>" width="200" onclick="MM_openBrWindow('admin/photozoom.php?fn=<? echo "site/monument/".$rec['photo3_monument']?>','','width=<? echo $t3[0]; ?>,height=<? echo $t3[1]; ?>')">
					<? }?>
					</td>
					<? }?>
                    <td valign="top">
...
<map name="Map" id="Map"><area shape="rect" coords="77,35,126,96" href="http://arpcv.free.fr" target="_blank" />
</map></body>
</html>