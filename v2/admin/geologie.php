        ...
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td align="right"><a href="geologie_def_modif.php" class="text">Modifier ces informations</a> </td>
              </tr>
            </table>
			<p align="right">&nbsp;</p>
			<p align="right"><a href="geologie_ajout.php" class="text">Ajouter dans géologie</a></p>
...
$sql = "select * from geo order by nom_geo ASC";
$qry = mysql_query($sql);
$i = 0;
...
?>
              <tr <? if ($i%2 == 1) echo "bgcolor=#ebfae1"?>>
                <td align="left"><? echo $rec['nom_geo']; ?></td>
                <td align="center"><? if ($rec['photo1_geo'] <> '') {?>
                    <img src="../decoup/photo.jpg" width="20" height="25" />
                    <? } ?></td>
                <td align="center"><a href="geologie_detail.php?id=<? echo $rec['id_geo']; ?>" class="text">En savoir plus ...</a></td>
                <td align="center"><a href="geologie_modif.php?id=<? echo $rec['id_geo']; ?>" class="text">Modifier</a></td>
                <td align="center"><a href="geologie_delete.php?id=<? echo $rec['id_geo']; ?>" class="text">Supprimer</a></td>
              </tr>
              <? $i++; } ?>
            </table>
			<p align="right">&nbsp;</p>
			<p align="right"><a href="biblio_geo_ajout.php" class="text">Ajouter d'une référence bibliographique</a></p>
			<table width="100%" border="0" cellspacing="0" cellpadding="1" class="text">
              <tr>
...
$sql = "select * from biblio_geo order by titre_biblio_geo ASC";
$qry = mysql_query($sql);
$i = 0;
while ($rec = mysql_fetch_array($qry)) {
...
?>
              <tr <? if ($i%2 == 1) echo "bgcolor=#ebfae1"?>>
                <td height="25" align="left"><? echo $rec['titre_biblio_geo']; ?></td>
                <td align="left"><? echo $rec['auteur_biblio_geo']; ?></td>
                <td align="left"><? echo $rec['editeur_biblio_geo'].' - '.$rec['annee_biblio_geo']; ?></td>
                <td align="center"><a href="biblio_geo_modif.php?id=<? echo $rec['id_biblio_geo']; ?>" class="text">Modifier</a></td>
                <td align="center"><a href="biblio_geo_delete.php?id=<? echo $rec['id_biblio_geo']; ?>" class="text">Supprimer</a></td>
              </tr>
              <? $i++; } ?>
            </table>
			<p>&nbsp;</p></td>
