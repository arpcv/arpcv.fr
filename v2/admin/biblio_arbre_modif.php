<?
	...
	$sql = "select * from biblio_arbre where id_biblio_arbre = ".$_REQUEST['id'];
	$qry = mysql_query($sql);
	$rec = mysql_fetch_array($qry);

	if (isset($_POST['post'])) {		
		$sql = "update biblio_arbre set titre_biblio_arbre = '".$_POST['titre']."', auteur_biblio_arbre = '".$_POST['auteur']."', editeur_biblio_arbre = '".$_POST['editeur']."', annee_biblio_arbre = '".$_POST['annee']."' where id_biblio_arbre = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="biblio_arbre_modif.php?id=<? echo $_REQUEST['id'];?>" method="post" onsubmit="MM_validateForm('titre','','R','auteur','','R','editeur','','R','annee','','R');return document.MM_returnValue" enctype="multipart/form-data">
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      <input name="titre" type="text" class="text" id="titre" value="<? echo $rec['titre_biblio_arbre']?>" size="50"/>                    </td>
                    </tr>
                  <tr>
                    <td align="left"><strong>Auteur : </strong></td>
                    <td align="left"><input name="auteur" type="text" class="text" id="auteur" value="<? echo $rec['auteur_biblio_arbre']?>" size="50"/></td>
                  </tr>
                  <tr>
                    <td align="left"><strong>Editeur : </strong></td>
                    <td align="left"><input name="editeur" type="text" class="text" id="editeur" value="<? echo $rec['editeur_biblio_arbre']?>" size="50"/></td>
                  </tr>
                  <tr>
                    <td align="left"><strong>Ann&eacute;e : </strong></td>
                    <td align="left"><input name="annee" type="text" class="text" id="annee" value="<? echo $rec['annee_biblio_arbre']?>" size="4" maxlength="4"/></td>
                  </tr>
                </table>                  </td>
              </tr>
              <tr>
