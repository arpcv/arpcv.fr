<?
	...
	if ($_POST) {
		$sql = "update accueil set garde_accueil = '$_POST[accueil]' where id_accueil = $_POST[id]";
		$qry = mysql_query($sql);
	}
        ...
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td><p align="right"><a href="accueil.php" class="text">Retour</a></p>
              <form id="form1" name="form1" method="post" action="garde.php">
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="150" valign="top" class="text"><strong>Texte page de garde  : </strong></td>
                  <td><textarea name="accueil" cols="50" rows="10" class="text" id="accueil"><? echo $rec['garde_accueil']; ?></textarea></td>
                </tr>
                <tr>
