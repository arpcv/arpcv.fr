<?
	...
	if (isset($_POST['post'])) {
		...
		$sql = "insert into liens values('', ".$_POST['rubrique'].", '".$_POST['nom']."', '".$_POST['url']."', '".$_POST['description']."')";
		$qry = mysql_query($sql);
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="liens_ajout.php" method="post" onsubmit="MM_validateForm('nom','','R','url','','R');return document.MM_returnValue" enctype="multipart/form-data">
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					?>
					  <option value="<? echo $recr['id_liens_rubrique']; ?>"><? echo $recr['nom_liens_rubrique']; ?></option>
					 <? } ?>
                    </select>
                    </td>
                  </tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left"><input name="url" type="text" class="text" id="url" size="50"/>                    </td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left"><input name="description" type="text" class="text" id="description" size="50"/>                    </td>
                  </tr>
                </table></td>
              </tr>
              <tr>
