<?
	...
	if (isset($_POST['post'])) {
		...
		$sql = "insert into faune_categorie values('', '".$_POST['nom']."', '".$_POST['texte']."', '".$photo."')";
		$qry = mysql_query($sql);
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="faune_ajout.php" method="post" onsubmit="MM_validateForm('nom','','R','intro','','R');return document.MM_returnValue" enctype="multipart/form-data">
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="150" align="left"><strong>Nom de la cat&eacute;gorie: </strong></td>
                    <td align="left">
