	...
	if (isset($_POST['post'])) {
		...
		if (isset($_FILES['fto1'])) {
			if ($_FILES['fto1']['size'] > 0) {
				$savefile = "../images/flore/".$_FILES['fto1']['name'];
		...
		if (isset($_FILES['fto2'])) {
			if ($_FILES['fto2']['size'] > 0) {
				$savefile = "../images/flore/".$_FILES['fto2']['name'];
		...
		if (isset($_FILES['fto3'])) {
			if ($_FILES['fto3']['size'] > 0) {
				$savefile = "../images/flore/".$_FILES['fto3']['name'];
		...
		if (isset($_FILES['fto4'])) {
			if ($_FILES['fto4']['size'] > 0) {
				$savefile = "../images/flore/".$_FILES['fto4']['name'];
		...
		if (isset($_FILES['fto5'])) {
			if ($_FILES['fto5']['size'] > 0) {
				$savefile = "../images/flore/".$_FILES['fto5']['name'];
		...
		$sql = "update flore set nom_flore = '".$_POST['nom']."', nomsc_flore = '".$_POST['nomsc']."', intro_flore = '".$_POST['intro']."', desc_flore = '".$_POST['desc']."', eco_flore = '".$_POST['eco']."', util_flore = '".$_POST['util']."', photo1_flore = '".$photo1."', photo2_flore = '".$photo2."', photo3_flore = '".$photo3."', photo4_flore = '".$photo4."', photo5_flore = '".$photo5."' where id_flore = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
//		echo $sql;
    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td>
			<p align="right"><a href="flore.php" class="text">Retour</a></p>
			<form action="flore_modif.php?id=<? echo $_REQUEST['id']?>" method="post" onsubmit="MM_validateForm('nom','','R','nomsc','','R','intro','','R','desc','','R','eco','','R','util','','R');return document.MM_returnValue" enctype="multipart/form-data">
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      <input name="nom" type="text" class="text" id="nom" value="<? echo $rec['nom_flore']?>">
                    </td>
                    <td width="150" align="left"><strong>Nom scientifique : </strong></td>
                    <td><input name="nomsc" type="text" class="text" id="nomsc" value="<? echo $rec['nomsc_flore']?>"></td>
                  </tr>
                </table>                  </td>
              </tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                  <tr>
                    <td width="50%"><textarea name="intro" cols="50" rows="10" class="text" id="intro"><? echo $rec['intro_flore']?></textarea></td>
                    <td width="50%"><textarea name="desc" cols="50" rows="10" class="text" id="desc"><? echo $rec['desc_flore']?></textarea></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                  <tr>
                    <td width="50%"><textarea name="eco" cols="50" rows="10" class="text" id="eco"><? echo $rec['eco_flore']?></textarea></td>
                    <td width="50%"><textarea name="util" cols="50" rows="10" class="text" id="util"><? echo $rec['util_flore']?></textarea></td>
                  </tr>
                </table></td>
              </tr>
