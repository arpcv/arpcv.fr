<?
	...
	$sql = "select * from photo_rubrique where id_photo_rubrique = ".$_REQUEST['id'];
	$qry = mysql_query($sql);
	$rec = mysql_fetch_array($qry);

	if (isset($_POST['post'])) {		
		$sql = "update photo_rubrique set nom_photo_rubrique = '".$_POST['nom']."' where id_photo_rubrique = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="photo_rubrique_modif.php?id=<? echo $_REQUEST['id'];?>" method="post" onsubmit="MM_validateForm('nom','','R');return document.MM_returnValue" enctype="multipart/form-data">
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      <input name="nom" type="text" class="text" id="nom" value="<? echo $rec['nom_photo_rubrique']?>" size="50"/>                    </td>
                    </tr>
                </table>                  </td>
              </tr>
              <tr>
