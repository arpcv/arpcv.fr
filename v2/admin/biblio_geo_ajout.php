<?
	...
	if (isset($_POST['post'])) {		
		$sql = "insert into biblio_geo values('', '".$_POST['titre']."', '".$_POST['auteur']."', '".$_POST['editeur']."', '".$_POST['annee']."')";
		$qry = mysql_query($sql);
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="biblio_geo_ajout.php" method="post" onsubmit="MM_validateForm('titre','','R','auteur','','R','editeur','','R','annee','','R');return document.MM_returnValue" enctype="multipart/form-data">
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      <input name="titre" type="text" class="text" id="titre"/>                    </td>
                    </tr>
                  <tr>
                    <td align="left"><strong>Auteur : </strong></td>
                    <td align="left"><input name="auteur" type="text" class="text" id="auteur"/></td>
                  </tr>
                  <tr>
                    <td align="left"><strong>Editeur : </strong></td>
                    <td align="left"><input name="editeur" type="text" class="text" id="editeur"/></td>
                  </tr>
                  <tr>
                    <td align="left"><strong>Ann&eacute;e : </strong></td>
                    <td align="left"><input name="annee" type="text" class="text" id="annee" maxlength="4"/></td>
                  </tr>
                </table>                  </td>
              </tr>
              <tr>
