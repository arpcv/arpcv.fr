<?
	...
	if (isset($_REQUEST['id'])) {
		$sql = "select * from insecte where id_insecte =".$_REQUEST['id'];
		$qry = mysql_query($sql);
	...
	if (isset($_POST['post'])) {
		...
		if (isset($_FILES['fto'])) {
			if ($_FILES['fto']['size'] > 0) {
				$savefile = "../images/insecte/".$_FILES['fto']['name'];
		...
		$sql = "update insecte set nom_insecte = '".$_POST['nom']."', texte_insecte = '".$_POST['texte']."', photo_insecte = '".$photo."' where id_insecte = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
//		echo $sql;
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="insecte_modif.php?id=<? echo $_REQUEST['id']?>" method="post" onsubmit="MM_validateForm('nom','','R','texte','','R');return document.MM_returnValue" enctype="multipart/form-data">
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      <input name="nom" type="text" class="text" id="nom" value="<? echo $rec['nom_insecte']?>">                    </td>
                    </tr>
                </table>                  </td>
              </tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                  <tr>
                    <td width="50%"><textarea name="texte" cols="50" rows="10" class="text" id="texte"><? echo $rec['texte_insecte']?></textarea></td>
                    </tr>
                </table></td>
              </tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      ...
                      <input name="foto" type="hidden" id="foto"  value="<? echo $rec['photo_insecte'];?>">                    </td>
                    </tr>
                </table></td>
              </tr>
              <tr>
