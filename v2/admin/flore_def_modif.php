<?
	...
	if (isset($_POST['post'])) {
		...
		$sql = "update flore_param set definition = '".$_POST['def']."', biblio = '".$_POST['biblio']."'";
		$qry = mysql_query($sql);
//		echo $sql;
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="flore_def_modif.php?id=<? echo $_REQUEST['id']?>" method="post" onsubmit="MM_validateForm('def','','R');return document.MM_returnValue" enctype="multipart/form-data">
			<table width="100%" border="0" cellspacing="1" cellpadding="1">

              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                    <tr>
                      <td width="50%" align="left"><strong>D&eacute;finition : </strong></td>
                      </tr>
                  </table></td>
              </tr>
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                  <tr>
                    <td width="50%"><textarea name="def" cols="100" rows="10" class="text" id="def"><? echo $rec['definition']?></textarea></td>
                    </tr>
                </table></td>
              </tr>
