	...
	if (isset($_POST['update'])) {
		...
		if (isset($_FILES['fto1'])) {
			if ($_FILES['fto1']['size'] > 0) {
				$savefile = "../images/site/".$_FILES['fto1']['name'];
		...
		if (isset($_FILES['fto2'])) {
			if ($_FILES['fto2']['size'] > 0) {
				$savefile = "../images/site/".$_FILES['fto2']['name'];
		...
		if (isset($_FILES['fto3'])) {
			if ($_FILES['fto3']['size'] > 0) {
				$savefile = "../images/site/".$_FILES['fto3']['name'];
		...
		$sql = "UPDATE monument SET nom_monument = '".$_POST['nom']."', texte_monument = '".$_POST['texte']."', photo1_monument = '".$photo1."', photo2_monument = '".$photo2."', photo3_monument = '".$photo3."' WHERE id_monument = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td>
			<p align="right"><a href="site.php?" class="text">Retour</a></p>
			<form action="site_modif.php?id=<? echo $_REQUEST['id']; ?>" method="post" onsubmit="MM_validateForm('nom','','R');return document.MM_returnValue" enctype="multipart/form-data">
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      <input name="nom" type="text" class="text" id="nom" value="<? echo $rec['nom_monument']; ?>"/></td>
                  </tr>
                </table>                  </td>
              </tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                  <tr>
                    <td width="50%"><textarea name="texte" cols="100" rows="10" class="text" id="texte"><? echo $rec['texte_monument']; ?></textarea></td>
                    </tr>
                </table></td>
              </tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      ...
                      <input name="foto1" type="hidden" id="foto1"  value="<? echo $rec['photo1_monument'];?>" /></td>
                  </tr>
                  <tr>
                    <td align="left"><strong>Photo 2 : </strong></td>
                    <td align="left"><input name="fto2" type="file" class="text" id="fto2" size="20" />
                      <input name="foto2" type="hidden" id="foto2" value="<? echo $rec['photo2_monument'];?>" /></td>
                  </tr>
                  <tr>
                    <td align="left"><strong>Photo 3 : </strong></td>
                    <td align="left"><input name="fto3" type="file" class="text" id="fto3" size="20" />
                      <input name="foto3" type="hidden" id="foto3" value="<? echo $rec['photo3_monument'];?>" /></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
