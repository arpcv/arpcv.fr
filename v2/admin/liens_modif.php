<?
	...
	if (isset($_REQUEST['id'])) {
		$sql = "select * from liens where id_liens =".$_REQUEST['id'];
		$qry = mysql_query($sql);
		$rec = mysql_fetch_array($qry);
	}
	
	if (isset($_POST['post'])) {				
		$sql = "update liens set nom_liens = '".$_POST['nom']."', url_liens = '".$_POST['url']."', description_liens = '".$_POST['description']."', idliensrubrique_liens = ".$_POST['rubrique']." where id_liens = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td>
			<p align="right"><a href="liens.php" class="text">Retour</a></p>
			<form action="liens_modif.php?id=<? echo $_REQUEST['id']?>" method="post" onsubmit="MM_validateForm('nom','','R','url','','R');return document.MM_returnValue" enctype="multipart/form-data">
			  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="left">
						<select name="rubrique" class="text">
                            <?
					$sqlr = "select * from liens_rubrique";
					$qryr = mysql_query($sqlr);
					while ($recr = mysql_fetch_array($qryr)) {
					?>
                            <option value="<? echo $recr['id_liens_rubrique']; ?>" <? if ($rec['idliensrubrique_liens'] == $recr['id_liens_rubrique']) echo "selected"; ?> ><? echo $recr['nom_liens_rubrique']; ?></option>
                            <? } ?>
                          </select>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td align="left"><input name="nom" type="text" class="text" id="nom" size="50" value="<? echo $rec['nom_liens']; ?>">
                        </td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="150" align="left"><strong>Liens  : </strong></td>
                        <td align="left"><input name="url" type="text" class="text" id="url" size="50" value="<? echo $rec['url_liens']; ?>">
                        </td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="left"><input name="description" type="text" class="text" id="description" size="50" value="<? echo $rec['description_liens']; ?>">
                        </td>
                      </tr>
                  </table></td>
                </tr>
