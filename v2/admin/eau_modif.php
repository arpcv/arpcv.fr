<?
	...
	if (isset($_POST['post'])) {		
		...
		$sql = "update geo set nom_barrage = '".$_POST['nom']."', texte_geo = '".$_POST['intro']."', photo1_barrage = '".$photo1."', photo2_barrage = '".$photo2."', photo3_barrage = '".$photo3."' where id_barrage = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
//		echo $sql;
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="eau_modif.php?id=<? echo $_REQUEST['id']?>" method="post" onsubmit="MM_validateForm('nom','','R','intro','','R');return document.MM_returnValue" enctype="multipart/form-data">
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      <input name="nom" type="text" class="text" id="nom" value="<? echo $rec['nom_barrage']?>">                    </td>
                    </tr>
                </table>                  </td>
              </tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                  <tr>
                    <td width="50%"><textarea name="intro" cols="100" rows="10" class="text" id="intro"><? echo $rec['texte_barrage']?></textarea></td>
                    </tr>
                </table></td>
              </tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      ...
                      <input name="foto1" type="hidden" id="foto1"  value="<? echo $rec['photo1_barrage'];?>">                    </td>
                    </tr>
                  <tr>
                    <td align="left"><strong>Photo 2 : </strong></td>
                    <td align="left"><input name="fto2" type="file" class="text" id="fto2" size="20" />
                      <input name="foto2" type="hidden" id="foto2"  value="<? echo $rec['photo2_barrage'];?>"></td>
                    </tr>
                  <tr>
                    <td align="left"><strong>Photo 3 : </strong></td>
                    <td align="left"><input name="fto3" type="file" class="text" id="fto3" size="20" />
                      <input name="foto3" type="hidden" id="foto3" value="<? echo $rec['photo3_barrage'];?>"></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
