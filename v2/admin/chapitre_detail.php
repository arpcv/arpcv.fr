    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td><p align="right"><a href="chapitre.php?village=<? echo $_REQUEST['village']; ?>" class="text">Retour</a></p>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                  <tr>
					...
					?>
					<img src="../images/village/<? echo $rec['photo1_chapitre']?>" width="200" onclick="MM_openBrWindow('photozoom.php?fn=<? echo "../images/village/".$rec['photo1_chapitre']?>','','width=<? echo $t1[0]; ?>,height=<? echo $t1[1]; ?>')">
					<? }?>
					 <br /><br /> 
					<?
					...
					?>
					<img src="../images/village/<? echo $rec['photo2_chapitre']?>" width="200" onclick="MM_openBrWindow('photozoom.php?fn=<? echo "../images/village/".$rec['photo2_chapitre']?>','','width=<? echo $t2[0]; ?>,height=<? echo $t2[1]; ?>')">
					<? }?>
					<br /><br />
					<?
					...
					?>
					<img src="../images/village/<? echo $rec['photo3_chapitre']?>" width="200" onclick="MM_openBrWindow('photozoom.php?fn=<? echo "../images/village/".$rec['photo3_chapitre']?>','','width=<? echo $t3[0]; ?>,height=<? echo $t3[1]; ?>')">
					<? }?>
					</td>
					<? }?>
                    <td valign="top">
					...
					<? if (strlen($rec['nom_chapitre']) > 0) { ?>
                      <tr>
                        <td align="center"><b><? echo ucwords($rec['nom_chapitre']); ?></b></td>
                      </tr>
					<? } ?>
                    </table>
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
