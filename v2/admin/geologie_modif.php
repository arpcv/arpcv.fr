	...
	if (isset($_POST['post'])) {		
		...
		if (isset($_FILES['fto1'])) {
			if ($_FILES['fto1']['size'] > 0) {
				$savefile = "../images/geologie/".$_FILES['fto1']['name'];
		...
		if (isset($_FILES['fto2'])) {
			if ($_FILES['fto2']['size'] > 0) {
				$savefile = "../images/geologie/".$_FILES['fto2']['name'];
		...
		if (isset($_FILES['fto3'])) {
			if ($_FILES['fto3']['size'] > 0) {
				$savefile = "../images/geologie/".$_FILES['fto3']['name'];
		...
		$sql = "update geo set nom_geo = '".$_POST['nom']."', texte_geo = '".$_POST['intro']."', photo1_geo = '".$photo1."', photo2_geo = '".$photo2."', photo3_geo = '".$photo3."' where id_geo = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
//		echo $sql;
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="geologie_modif.php?id=<? echo $_REQUEST['id']?>" method="post" onsubmit="MM_validateForm('nom','','R','intro','','R');return document.MM_returnValue" enctype="multipart/form-data">
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="150" height="25" align="left"><strong>Rubrique: </strong></td>
                    <td align="left">
                      <input name="nom" type="text" class="text" id="nom" value="<? echo $rec['nom_geo']?>">                    </td>
                    </tr>
                </table>                  </td>
              </tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                  <tr>
                    <td width="50%"><textarea name="intro" cols="100" rows="10" class="text" id="intro"><? echo $rec['texte_geo']?></textarea></td>
                    </tr>
                </table></td>
              </tr>
