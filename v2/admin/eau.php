        ...
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td align="left"><strong>Edito sur les Eau &amp; Barrages : </strong></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="right"><a href="eau_def_modif.php" class="text">Modifier ces informations</a> </td>
              </tr>
            </table>
			<p align="right">&nbsp;</p>
			<p align="right"><a href="eau_ajout.php" class="text">Ajouter dans Eau & Barrage</a></p>
...
$sql = "select * from barrage order by nom_barrage ASC";
$qry = mysql_query($sql);
$i = 0;
...
?>
              <tr <? if ($i%2 == 1) echo "bgcolor=#ebfae1"?>>
                ...
                <td align="center"><a href="eau_modif.php?id=<? echo $rec['id_barrage']; ?>" class="text">Modifier</a></td>
                <td align="center"><a href="eau_delete.php?id=<? echo $rec['id_barrage']; ?>" class="text">Supprimer</a></td>
              </tr>
              <? $i++; } ?>
            </table>
			<p align="right">&nbsp;</p>
			<p align="right"><a href="biblio_eau_ajout.php" class="text">Ajouter d'une référence bibliographique</a></p>
			<table width="100%" border="0" cellspacing="0" cellpadding="1" class="text">
              <tr>
...
$sql = "select * from biblio_barrage order by titre_biblio_barrage ASC";
$qry = mysql_query($sql);
$i = 0;
while ($rec = mysql_fetch_array($qry)) {
...
?>
              <tr <? if ($i%2 == 1) echo "bgcolor=#ebfae1"?>>
                ...
                <td align="center"><a href="biblio_eau_modif.php?id=<? echo $rec['id_biblio_barrage']; ?>" class="text">Modifier</a></td>
                <td align="center"><a href="biblio_eau_delete.php?id=<? echo $rec['id_biblio_barrage']; ?>" class="text">Supprimer</a></td>
              </tr>
              <? $i++; } ?>
            </table>
			<p>&nbsp;</p></td>
