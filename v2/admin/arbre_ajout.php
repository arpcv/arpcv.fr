<?
	...
	if (isset($_POST['post'])) {
		...
		$sql = "insert into arbre values('', '".$_POST['nom']."', '".$_POST['nomsc']."', '".$_POST['intro']."', '".$_POST['desc']."', '".$_POST['eco']."', '".$_POST['util']."', '".$photo1."', '".$photo2."', '".$photo3."', '".$photo4."', '".$photo5."')";
		$qry = mysql_query($sql);
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="arbre_ajout.php" method="post" onsubmit="MM_validateForm('nom','','R','nomsc','','R');return document.MM_returnValue" enctype="multipart/form-data">
