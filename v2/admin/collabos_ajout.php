<?
	...
	if (isset($_POST['post'])) {
		...
		$sql = "insert into collabos values('', '".$_POST['nom']."', '".$_POST['email']."', '".$_POST['description']."')";
		$qry = mysql_query($sql);
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="collabos_ajout.php" method="post" onsubmit="MM_validateForm('nom','','R','email','','RisEmail');return document.MM_returnValue" enctype="multipart/form-data">
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left"><input name="email" type="text" class="text" id="email" size="50"/>                    </td>
                  </tr>
                </table></td>
              </tr>
              <tr>
