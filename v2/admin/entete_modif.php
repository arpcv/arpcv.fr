<?
	...
	if ($_POST) {
		$sql = "update entete set texte_entete = '$_POST[texte]' where id_entete = $_POST[id]";
		$qry = mysql_query($sql);
	}
	$sql = "select * from entete where id_entete=".$_REQUEST['id'];
	$qry = mysql_query($sql);
    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td><p align="right"><a href="entete.php" class="text">Retour</a></p>
              <form id="form1" name="form1" method="post" action="entete_modif.php">
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="150" valign="top" class="text"><strong>Texte : </strong></td>
                  <td><textarea name="texte" cols="50" rows="10" class="text" id="texte"><? echo $rec['texte_entete']; ?></textarea></td>
                </tr>
                <tr>
                  <td colspan="2" align="center" class="text"><input name="id" type="hidden" id="id" value="<? echo $rec['id_entete']; ?>" />
