<?
	...
	if (isset($_REQUEST['id'])) {
		$sql = "select * from village where id_village =".$_REQUEST['id'];
		$qry = mysql_query($sql);
	...
	if (isset($_POST['post'])) {
		...
		$sql = "update village set nom_village = '".$_POST['nom']."' where id_village = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
//		echo $sql;
    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td>
			<p align="right"><a href="village.php" class="text">Retour</a></p>
			<form action="village_modif.php?id=<? echo $_REQUEST['id']?>" method="post" onsubmit="MM_validateForm('nom','','R');return document.MM_returnValue" enctype="multipart/form-data">
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="left">
                      <input name="nom" type="text" class="text" id="nom" value="<? echo $rec['nom_village']?>">                    </td>
                    </tr>
                </table>                  </td>
              </tr>
              <tr>
