<?
	...
	if (isset($_POST['post'])) {
		...
		$sql = "insert into flore values('', '".$_POST['nom']."', '".$_POST['nomsc']."', '".$_POST['intro']."', '".$_POST['desc']."', '".$_POST['eco']."', '".$_POST['util']."', '".$photo1."', '".$photo2."', '".$photo3."', '".$photo4."', '".$photo5."')";
		$qry = mysql_query($sql);
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<form action="flore_ajout.php" method="post" onsubmit="MM_validateForm('nom','','R','nomsc','','R');return document.MM_returnValue" enctype="multipart/form-data">
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="150" align="left"><strong>Nom commun : </strong></td>
                    <td align="left">
                      <input name="nom" type="text" class="text" id="nom"/>
                    </td>
                    <td width="150" align="left"><strong>Nom scientifique : </strong></td>
                    <td><input name="nomsc" type="text" class="text" id="nomsc" /></td>
                  </tr>
                </table>                  </td>
              </tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                  <tr>
                    <td width="50%"><textarea name="intro" cols="50" rows="10" class="text" id="intro"></textarea></td>
                    <td width="50%"><textarea name="desc" cols="50" rows="10" class="text" id="desc"></textarea></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
                  <tr>
                    <td width="50%"><textarea name="eco" cols="50" rows="10" class="text" id="eco"></textarea></td>
                    <td width="50%"><textarea name="util" cols="50" rows="10" class="text" id="util"></textarea></td>
                  </tr>
                </table></td>
              </tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="fto4" type="file" class="text" id="fto4" size="20" /></td>
                  </tr>
                  <tr>
                    <td align="left"><strong>Photo 5 : </strong></td>
                    <td align="left"><input name="fto5" type="file" class="text" id="fto5" size="20" /></td>
                    <td align="left">&nbsp;</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                </table></td>
