<?
	...
	if (isset($_POST['post'])) {
		...
		$sql = "insert into chapitre values('', ".$_POST['numero'].", '".$_POST['nom']."', '".$_POST['texte']."', '".$photo1."', '".$photo2."', '".$photo3."')";
		$qry = mysql_query($sql);
    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td>
			<p align="right"><a href="chapitre.php?village=<? echo $_REQUEST['village']; ?>" class="text">Retour</a></p>
			<form action="chapitre_ajout.php?village=<? echo $_REQUEST['village']; ?>" method="post" onsubmit="MM_validateForm('nom','','R');return document.MM_returnValue" enctype="multipart/form-data">
