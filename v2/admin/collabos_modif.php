<?
	...
	if (isset($_REQUEST['id'])) {
		$sql = "select * from collabos where id_collabos=".$_REQUEST['id'];
		$qry = mysql_query($sql);
		$rec = mysql_fetch_array($qry);
	}
	
	if (isset($_POST['post'])) {				
		$sql = "update collabos set nom_collabos = '".$_POST['nom']."', email_collabos= '".$_POST['email']."', description_collabos= '".$_POST['description']."' where id_collabos = ".$_REQUEST['id'];
		$qry = mysql_query($sql);
		header("location:collabos.php");
	}
    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td>
			<p align="right"><a href="collabos.php" class="text">Retour</a></p>
			<form action="collabos_modif.php?id=<? echo $_REQUEST['id']?>" method="post" onsubmit="MM_validateForm('nom','','R','email','','NisEmail');return document.MM_returnValue" enctype="multipart/form-data">
			  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="150" align="left"><strong>Nom Pr&eacute;nom : </strong></td>
                        <td align="left"><input name="nom" type="text" class="text" id="nom" size="50" value="<? echo $rec['nom_collabos']; ?>">                        </td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="150" align="left"><strong>EMail  : </strong></td>
                        <td align="left"><input name="email" type="text" class="text" id="email" size="50" value="<? echo $rec['email_collabos']; ?>">
                        </td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="left"><input name="description" type="text" class="text" id="description" size="50" value="<? echo $rec['description_collabos']; ?>">
                        </td>
                      </tr>
                  </table></td>
                </tr>
