        ...
        <td background="../decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td align="right"><a href="arbre_def_modif.php" class="text">Modifier ces informations</a> </td>
              </tr>
            </table>
			<p align="right">&nbsp;</p>
			<p align="right"><a href="arbre_ajout.php" class="text">Ajouter un arbre</a></p>
...
?>
  <tr <? if ($i%2 == 1) echo "bgcolor=#ebfae1"?>>
    ...
    <td align="center"><a href="arbre_modif.php?id=<? echo $rec['id_arbre']; ?>" class="text">Modifier</a></td>
    <td align="center"><a href="arbre_delete.php?id=<? echo $rec['id_arbre']; ?>" class="text">Supprimer</a></td>
  </tr>
<? $i++; } ?>
			</table>
			<p align="right">&nbsp;</p>
			<p align="right"><a href="biblio_arbre_ajout.php" class="text">Ajouter d'une référence bibliographique</a></p>
			<table width="100%" border="0" cellspacing="0" cellpadding="1" class="text">
              <tr>
...
$sql = "select * from biblio_arbre order by titre_biblio_arbre ASC";
$qry = mysql_query($sql);
while ($rec = mysql_fetch_array($qry)) {
...
?>
              <tr>
                ...
                <td align="center"><a href="biblio_arbre_modif.php?id=<? echo $rec['id_biblio_arbre']; ?>" class="text">Modifier</a></td>
                <td align="center"><a href="biblio_arbre_delete.php?id=<? echo $rec['id_biblio_arbre']; ?>" class="text">Supprimer</a></td>
              </tr>
              <? } ?>
            </table>
			<p>&nbsp;</p></td>
