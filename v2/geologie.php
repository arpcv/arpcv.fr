<?
	...
	$sql = "select * from entete where chapitre_entete = 'geo'";
	$qry = mysql_query($sql);
	$entete = mysql_fetch_array($qry);
	
	$sql_param = "select * from geo_param";
    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          <tr>
            <td><img src="decoup/titre_geologie.jpg" width="207" height="26" /></td>
          </tr>
          <tr>
...
<map name="Map" id="Map"><area shape="rect" coords="78,35,130,95" href="http://arpcv.free.fr" target="_blank" />
</map></body>
</html>
<?
	mysql_close();
