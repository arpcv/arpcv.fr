<?
	...
	$sql = "select * from entete where chapitre_entete = 'administratif'";
	$qry = mysql_query($sql);
    ...
    <td width="780" align="center" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td background="decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
            <td><strong><? echo $entete['texte_entete']; ?></strong></td>
          </tr>
          <tr>
            <td><p>&nbsp;</p>
              <p><strong>Vous trouverez tous les renseignements sur les sites:</strong><br />
                <br />
                Le Grand Site Sainte   Victoire :
                <a href="http://www.grandsitesaintevictoire.com/" target="_blank" class="text">http://www.grandsitesaintevictoire.com/</a><br />
                <br />
                Les   Amis de Sainte Victoire :<a href="http://www.amisdesaintevictoire.asso.fr/montagne sainte victoire/grand_site.html" target="_blank" class="text">                http://www.amisdesaintevictoire.asso.fr/montagne%20sainte%20victoire/grand_site.html</a></p>
              <p><br />
                </p></td>
          </tr>
        </table></td>
...
<map name="Map" id="Map"><area shape="rect" coords="78,35,130,94" href="http://arpcv.free.fr" target="_blank" />
</map></body>
</html>
<?
	mysql_close();
