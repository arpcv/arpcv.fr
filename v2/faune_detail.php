<?
	...
	if ($nbrec == 0) header("location:faune.php");
	mysql_close();
      ...
      <tr>
        <td background="decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<? } else { ?>
			<a href="faune.php" class="text">Retour</a>
			<? } ?>
			</p>
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                  <tr>
					<? if (strlen($rec['photo_faune_categorie'])>0) { ?>				
                    <td width="240" align="center" valign="top">
					<?
					if (strlen($rec['photo_faune_categorie'])>0) {					
					$t1 = getimagesize("images/faune/".$rec['photo_faune_categorie']);
					?>
					<img src="images/faune/<? echo $rec['photo_faune_categorie']?>" width="200" onclick="MM_openBrWindow('photozoom.php?fn=<? echo "images/faune/".$rec['photo_faune_categorie']?>','','width=<? echo $t1[0]; ?>,height=<? echo $t1[1]; ?>')">
					<? }?>
					</td>
					<? }?>
                    <td valign="top">
					<table width="100%" border="0" cellpadding="1" cellspacing="1" class="texttitre">
					<? if (strlen($rec['nom_faune_categorie']) > 0) { ?>
                      <tr>
                        <td align="center"><b><? echo ucwords($rec['nom_faune_categorie']); ?></b></td>
                      </tr>
					<? } ?>
                    </table>
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
                      <? if (strlen($rec['texte_faune_categorie']) > 0) { ?>
                      <tr>
                        <td align="left"><br />
                            <b>G&eacute;n&eacute;ralit&eacute;s :</b><br />
                          <? echo $rec['texte_faune_categorie']; ?></td>
                      </tr>
                      <? } ?>
                    </table></td>
                  </tr>
...
<map name="Map" id="Map"><area shape="rect" coords="79,37,129,95" href="http://arpcv.free.fr" target="_blank" />
</map></body>
</html>