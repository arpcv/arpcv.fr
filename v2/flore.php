<?
	...
	$sql = "select * from entete where chapitre_entete = 'flore'";
	$qry = mysql_query($sql);
        ...
        <td background="decoup/model_fond.jpg"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="text">
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td align="left"><? echo substr($rec['definition'],0, 300)." ..."; ?><p align="right"><a href="#" class="text" onclick="MM_openBrWindow('texte_flore.php','','status=yes,width=500,height=400')">En savoir plus ...</a></p></td>
              </tr>
            </table>
			<p align="right">&nbsp;</p>
...
<map name="Map" id="Map"><area shape="rect" coords="76,34,129,96" href="http://arpcv.free.fr" target="_blank" />
</map></body>
</html>
<?
	mysql_close();
